...
@section('content')
<div class="mx-auto flex justify-center flex-wrap bg-gray-300 py-8">
    <div class="md:w-96 w-72 bg-blue-900 rounded-lg shadow-xl p-6"> 
        ...
        <form method="POST" action="{{ route('register') }}" class="pt-8">
            ...
            <div class="relative">
                <label for="name" class="uppercase text-blue-500 text-xs font-bold pl-3 pt-2 absolute">Full name</label>
